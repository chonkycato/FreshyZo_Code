...
class RecyclerAdapterSubPaused : RecyclerView.Adapter<RecyclerAdapterSubPaused.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var pauseStartDate: TextView
        var pauseEndDate: TextView
...
//        var location: TextView
        ...
        init {
            ...
            pauseStartDate = itemView.findViewById(R.id.startDateSubTVPSub)
            pauseEndDate = itemView.findViewById(R.id.pauseDateSubTVPSub)
...
//            location = itemView.findViewById(R.id.deliveryLocationTVPSub)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.pauseStartDate.text = item.pauseStartDate
        holder.pauseEndDate.text = item.pauseEndDate
